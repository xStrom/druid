...
impl From<druid_shell::MoveEvent> for MoveEvent {
    fn from(src: druid_shell::MoveEvent) -> MoveEvent {
        let druid_shell::MoveEvent { pos, buttons, mods } = src;
        MoveEvent {
            pos,
            window_pos: pos,
            buttons,
...
impl From<druid_shell::ClickEvent> for ClickEvent {
    fn from(src: druid_shell::ClickEvent) -> ClickEvent {
        let druid_shell::ClickEvent {
            pos,
            buttons,
            mods,
            count,
